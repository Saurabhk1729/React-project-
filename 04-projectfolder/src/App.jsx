...
const App = () => {
 ...
 console.log(jobOpenings);
  ...
  return (
    <div className='parent'>      {jobOpenings.map(function(elem){
        return <Card company={elem.companyName} payment={elem.pay} one={elem.tag1} two={elem.tag2} loc={elem.location} post={elem.post} datepost={elem.datePosted} logo={elem.brandLogo}/>
      })}
    </div>
  )
}
